...
$resultado_consulta = mysqli_fetch_assoc($resultado);
	...
	if ($registros>0){ ?>
		...
		$consulta = $connection->prepare("INSERT INTO atividade (CodProf,nome,preco,dia,mes,ano,horario,modalidade,publica,codLocal,aula,descricao) VALUES ('$CodProf','$nome','$preco','$dia','$mes','$ano','$horario','$modalidade','$publica','$CodLocal','$aula','$descricao')");
