...
$resultado_consulta = mysqli_fetch_assoc($resultado);
	...
	if ($registros>0){ ?>
		...
		$consulta = $connection->prepare("INSERT INTO locais (nome,precoAluguel,rua,cep,numero,bairro,estado,cidade,codProfessor) VALUES ('$nome','$precoAluguel','$rua','$cep','$numero','$estado','$cidade','$bairro','$codProfessor')");
